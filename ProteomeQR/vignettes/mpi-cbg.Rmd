...
ms_data_infos <- tempdir()
setwd(ms_data_infos)

ProteomeQRdir <- file.path(path.package(package = 'ProteomeQR'), "extdata", "mpi-cbg")
count_matrix_file <- file.path(ProteomeQRdir,  "data_prep.intens_imputed.txt")
design_matrix_file <- file.path(ProteomeQRdir, "exp_design.txt")
#contrasts_file <- opts$contrasts
contrasts_file <- file.path(ProteomeQRdir, "exp_design.txt")
#protein_info_file <-  opts$protein_info
protein_info_file <- file.path(ProteomeQRdir, "data_prep.feature_information.txt")


# file.copy( count_matrix_file , file.path(ms_data_infos, "data_prep.intens_imputed.txt"))
# file.copy( design_matrix_file, file.path(ms_data_infos, "exp_design.txt"))
